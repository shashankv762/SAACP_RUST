...
use saacp_primitives::errors::{SAACPBytecodes, SAACPHardDrop};
...
fn now_secs() -> f64 {
    saacp_primitives::clock::now_secs_f64()
}
...
impl ImmutableAuditLog {
    ...
    fn append_event_inner(
        ...
        let mut shard = match self.shards[shard_idx].try_lock() {
            ...
            Err(std::sync::TryLockError::WouldBlock) => {
                crate::crypto_telemetry().record_mutex_contention("wal_append");
    ...
    fn enqueue_wal_line(&self, entry_json: String) -> bool {
        ...
        if tx.try_send(msg).is_ok() {
            ...
            crate::crypto_telemetry().record_audit_gate_rejection();
            false
        }
