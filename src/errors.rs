...
impl SAACPBytecodes {
    ...
    pub const ALL: [SAACPBytecodes; Self::COUNT] = {
        ...
        [
            ...
            EpochExpired,
            SequenceOverflow,
            KeyEvolutionRequired,
            AegfLoopDetected,
            AegfHopLimitExceeded,
            AegfDepthLimitExceeded,
            AegfTtlExpired,
            AegfInvalidTransition,
            ScrUnauthorized,
            ScrNotFound,
            RrbcReplayDetected,
            RrbcUsageExhausted,
            RrbcBindingMismatch,
            RrbcPopFailed,
            RgcResourceLimitExceeded,
            KeyRevoked,
            KeyVersionMismatch,
            AcsvafDelegationAmplification,
            AcsvafDelegationDepthExceeded,
            AcsvafCircularDelegation,
            AcsvafOrphanChain,
            AcsvafMissingCapabilityAuthority,
            AcsvafKeyNotTrusted,
            AcsvafThresholdNotReached,
            AcsvafManifestInvalid,
            AcsvafSessionBindingViolated,
            SelfIssuedCapability,
            UnauthorizedIssuerClass,
            DelegationMetadataIncomplete,
            AuthorityClassViolation,
            FederationRootRequired,
            IdentityBindingMissing,
            IdentityMisbinding,
            TranscriptHashMismatch,
            IdentityNotVerified,
            SessionSpliceDetected,
            AuditSubsystemDegraded,
            TrustReauthRequired,
            IntentChainDriftExceeded,
            IntentClassEscalationDetected,
            SemanticInjectionDetected,
            InsufficientAttestation,
            CollusionDetected,
            ClusterMessageRejected,
            RulePackRejected,
        ]
    };
}
